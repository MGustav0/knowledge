<template>
    <div class="user-admin">
        <b-form>
            <!-- Aponta para user.id, se tiver setado ele vai marcar -->
            ...
            <!-- class="mt-3 mb-3" margens para o formulário -->
...
export default {
    ...
    data: function() {
        return {
            mode: 'save',
            user: {}, /**Objeto vazio */
            users: [], /**Array de objetos do sistema */
            fields: [
    ...
    methods: {
        ...
        loadUser(user, mode = 'save') {
            this.mode = mode
            /**Fazendo um clone usando spread para carregar no this.user referenciado no formulário */
            this.user = { ...user }
        }
    },
    mounted() {
